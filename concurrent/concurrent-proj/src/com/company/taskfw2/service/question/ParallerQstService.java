package com.company.taskfw2.service.question;

import com.company.taskfw2.assist.Consts;
import com.company.taskfw2.assist.SL_QuestionBank;
import com.company.taskfw2.vo.QuestionInCacheVo;
import com.company.taskfw2.vo.QuestionInDBVo;
import com.company.taskfw2.vo.TaskResultVo;
...
public class ParallerQstService {
    ...
    //正在处理题目的缓存，这里其实因为数量过大的情况也有点不合理，应该用ConcurrentLinkedHashMap
