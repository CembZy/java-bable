...
public class StoreConsumer {
    public static void main(String[] args) throws IOException {
        ...
        ReferenceConfig<VipUserService> reference = new ReferenceConfig<>();
        ...
        // 注意：此代理对象内部封装了所有通讯细节，对象较重，请缓存复用，这里使用了lazy懒加载方式，只有在get调用的时候，才会去加载所有的服务
        VipUserService vipUserService = reference.get();
